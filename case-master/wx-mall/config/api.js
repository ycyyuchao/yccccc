...
var NewApiRootUrl = 'http://www.muyingbei.com:8080/platform-framework/api/';

//  var NewApiRootUrl = 'http://192.168.0.2:8080/platform-framework/api/';
 //var NewApiRootUrl = 'http://localhost:8080/platform-framework/api/';


module.exports = {
  IndexGoods: NewApiRootUrl + 'index/indexGoods',
  ...
  SmsCode: NewApiRootUrl + 'sms/send', //发送短信
  ...
  ConsDetail: NewApiRootUrl + '/cons/detail', //积分明细
  getPoint: NewApiRootUrl + 'point/getPoint', //获取积分
  rankingDetails: NewApiRootUrl + 'point/ranking', //分享圈排行榜
  category: NewApiRootUrl + 'coupon/species', //首页头部导航栏
  getCoupon: NewApiRootUrl + 'coupon/getUserCoupon', //获取当前用户的所有优惠卷
  shareDetails: NewApiRootUrl + 'share/shareInfo ', //分享圈接口
  smsVerification: NewApiRootUrl + 'sms/validate', //短信验证
  sendMessage: NewApiRootUrl + 'sms/send',//发送短信
  applyCoupon: NewApiRootUrl + 'coupon/applyCoupon',//优惠券
  serverDetails: NewApiRootUrl + 'appoint/details'//预约详情
