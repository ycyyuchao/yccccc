...
export default class MineScreen extends Component{
  static defaultProps={
    orderList:[{title:'未付款',icon:{TabIcon}},
               {title:'运送中',icon:{TabIcon}},
               {title:'待评价',icon:{TabIcon}},
               {title:'退款/售后',icon:{TabIcon}}]
  };
  render(){
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <TouchableOpacity activeOpacity={0.5} style={styles.userInfo}>
            <Image source={{uri:'../assets/timg.jpg'}} style={styles.userPic} />
            <Text style={{fontSize:18}}>SuperTory</Text>
            <Image source={{uri:'../assets/timg.jpg'}} style={styles.userGrade} />
            <Image style={styles.headerArrow} source={{uri:'../assets/timg.jpg'}} />
          </TouchableOpacity>
